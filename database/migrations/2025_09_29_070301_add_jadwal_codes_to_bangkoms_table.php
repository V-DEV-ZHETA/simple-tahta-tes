...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Sample data yang hanya berisi kode jadwal
        $sampleCodes = [
            ['SPL-MHKZ', 'SPL-KLTQ'],
            ['SPL-PQRS', 'SPL-TUVX'],
            ['SPL-YZAB', 'SPL-CDEF'],
        ...
        foreach ($bangkoms as $index => $bangkom) {
            // Gunakan sample data berdasarkan index, atau buat data baru jika index melebihi sample
    ...
    {
        // Hapus data jadwal_codes dan status
        Bangkom::query()->update(['jadwal_codes' => null, 'status' => null]);
